...
export default function Tracker({ onSignOut, onHome, userEmail, dark, onToggleDark }) {
  ...
  const IcoWrench=()=><svg viewBox="0 0 20 20" fill="currentColor" className="w-[15px] h-[15px] shrink-0"><rect x="3" y="8.5" width="14" height="3" rx="1.5" transform="rotate(-45 10 10)"/><rect x="2" y="2" width="5" height="5" rx="1.5" transform="rotate(-45 4.5 4.5)"/><rect x="13" y="13" width="5" height="5" rx="1.5" transform="rotate(-45 15.5 15.5)"/></svg>;
